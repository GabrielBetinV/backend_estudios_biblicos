...
use App\Services\CursoInscritosService;
use App\DTO\CursoDTO;
use App\Helpers\JwtHelper;
use Exception;

class CursoIncritosController {
    private CursoInscritosService $cursoService;

    public function __construct() {
        $this->cursoService = new CursoInscritosService();
    }
