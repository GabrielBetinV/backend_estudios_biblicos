...
class ForoService {
    ...
    public function getPreguntasByCurso($id_curso,$id_usuario,$id_leccion,$id_subleccion, $id_grupo = null) {
        return $this->foroModel->getPreguntasByCurso($id_curso,$id_usuario,$id_leccion,$id_subleccion, $id_grupo);
    }
