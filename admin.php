...
switch ($action) {
    ...
    case 'cursos_inscritos':
        if ($method === 'GET') $adminController->getCursosByUsuario();
        break;
    ...
    case 'grupos':
        ...
        break;
    case 'grupos_estado':
        if ($method === 'POST') $adminController->updateEstadoGrupo();
        break;
    case 'inscripciones':
    ...
    case 'grupo_lecciones':
        ...
        break;
    case 'grupo_lecciones_fecha_limite':
        if ($method === 'POST') $adminController->setFechaLimiteLeccionGrupo();
        break;
    case 'lecciones_full':
